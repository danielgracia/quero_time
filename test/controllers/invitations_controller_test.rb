...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { state: @invitation.state, teams_id: @invitation.teams_id, users_id: @invitation.users_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { state: @invitation.state, teams_id: @invitation.teams_id, users_id: @invitation.users_id } }
