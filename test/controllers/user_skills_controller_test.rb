...
class UserSkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_skill" do
    assert_difference('UserSkill.count') do
      post user_skills_url, params: { user_skill: { level: @user_skill.level, skills_id: @user_skill.skills_id, users_id: @user_skill.users_id } }
    end
  ...
  test "should update user_skill" do
    patch user_skill_url(@user_skill), params: { user_skill: { level: @user_skill.level, skills_id: @user_skill.skills_id, users_id: @user_skill.users_id } }
